...
public class DefaultActionInvocation implements ActionInvocation {
     ...
     * @throws Exception 
     */
    protected String saveResult(ActionConfig actionConfig, Object methodResult) throws Exception {
        if (methodResult instanceof Result) {
			...
			Request.returnResult(ServletActionContext.getRequest(),ServletActionContext.getResponse(), methodResult);
			return null;
		} else {
