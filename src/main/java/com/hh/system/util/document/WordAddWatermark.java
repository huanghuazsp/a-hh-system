...
public class WordAddWatermark {
	private static WordAddWatermark instance;
...
//	 * @return 报表汇总业务操作
//	 */
//	public final static synchronized WordAddWatermark getInstance() {
//		if (instance == null)
//			instance = new WordAddWatermark();
//		return instance;
//
//	}
//
...
//		WordAddWatermark d = WordAddWatermark.getInstance();
//		try {
//			if (d.initWordObj()) {
//				d.openDocument("D:/test.doc");
//				d.getActiveWindow();
//				d.setWaterMark("安全厅");
//				d.closeWordObj();
//			} else
