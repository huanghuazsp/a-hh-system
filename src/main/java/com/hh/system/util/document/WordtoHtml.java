...
//		ComThread.InitSTA();
//		ActiveXComponent app = new ActiveXComponent("Word.Application");// 启动word
//		String inFile = "D:/word/test.docx";// 要转换的word文件
//		String otFile = "D:/word/test.xml";// 目标文件
//		boolean flag = false;
//		try {
...
//			Dispatch.invoke(doc, "SaveAs", Dispatch.Method, new Object[] {
//					otFile, new Variant(11) }, new int[1]);// 作为html格式保存到临时文件
...
//		// WordtoHtml.change("d:/aaa.docx", "d:/t.xml");
//		word2xml();
//	}
